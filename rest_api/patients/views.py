...
from .serializers import PatientSerializer, PatientCPFLoginSerializer
from rest_framework.generics import get_object_or_404
from rest_framework.exceptions import PermissionDenied
from .rabbitmq_publisher import send_to_worker
...
class TestPatientCreateView(generics.CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        for field in ['birth_date', 'gender', 'clinical_notes', 'additional_info', 'groups', 'user_permissions', 'is_test']:
            data.pop(field, None)
        ...
        patient_dict = {
            "patient_iid": patient.patient_iid,
            "birth_date": patient.birth_date.isoformat() if patient.birth_date else None,
            "age": patient.age,  # Agora é calculado automaticamente
            "gender": patient.gender,
            "clinical_notes": patient.clinical_notes,
            "additional_info": patient.additional_info,
            "created_at": patient.created_at.isoformat(),
