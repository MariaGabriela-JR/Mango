// app/bff/sessions/list/route.js
...
export async function GET() {
  try {
    ...
    const backendRes = await axios.get(`${getGatewayUrl()}/edf_files/edf-files/`, {
      headers: {
    ...
    console.error('Erro no BFF listSessions:', err.response?.data || err.message)
